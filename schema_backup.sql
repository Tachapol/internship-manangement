...
\restrict 6Pnb9ofigJlghjwhOEP7eoAyNhL8TT78y32KxCUZvRY4i9Lwb8LfuJ9aX3HHvL9
...
--
-- Name: TrainingPlanStatus; Type: TYPE; Schema: public; Owner: postgres
--

CREATE TYPE public."TrainingPlanStatus" AS ENUM (
    'ACTIVE',
    'COMPLETED',
    'ARCHIVED'
);
...
ALTER TYPE public."TrainingPlanStatus" OWNER TO postgres;
...
CREATE TABLE public.student_module_progress (
    ...
    status public."TrainingPlanStatus" DEFAULT 'ACTIVE'::public."TrainingPlanStatus" NOT NULL,
...
--
-- Name: training_plan_modules; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.training_plan_modules (
    id uuid NOT NULL,
    title text NOT NULL,
    description text,
...
ALTER TABLE public.training_plan_modules OWNER TO postgres;
...
--
-- Name: training_plan_modules training_plan_modules_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.training_plan_modules
    ADD CONSTRAINT training_plan_modules_pkey PRIMARY KEY (id);
...
--
-- Name: attendances_deletedAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "attendances_deletedAt_idx" ON public.attendances USING btree ("deletedAt");
...
--
-- Name: attendances_userId_date_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "attendances_userId_date_idx" ON public.attendances USING btree ("userId", date);
...
--
-- Name: audit_logs_entityName_entityId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "audit_logs_entityName_entityId_idx" ON public.audit_logs USING btree ("entityName", "entityId");


--
-- Name: companies_deletedAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "companies_deletedAt_idx" ON public.companies USING btree ("deletedAt");
...
--
-- Name: invitations_companyId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "invitations_companyId_idx" ON public.invitations USING btree ("companyId");
...
--
-- Name: invitations_teamId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "invitations_teamId_idx" ON public.invitations USING btree ("teamId");
...
--
-- Name: leave_requests_approvedById_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "leave_requests_approvedById_idx" ON public.leave_requests USING btree ("approvedById");


--
-- Name: leave_requests_deletedAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "leave_requests_deletedAt_idx" ON public.leave_requests USING btree ("deletedAt");


--
-- Name: leave_requests_startDate_endDate_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "leave_requests_startDate_endDate_idx" ON public.leave_requests USING btree ("startDate", "endDate");
...
--
-- Name: leave_requests_studentId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "leave_requests_studentId_idx" ON public.leave_requests USING btree ("studentId");
...
--
-- Name: password_reset_tokens_expiresAt_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: password_reset_tokens_userId_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: student_module_progress_moduleId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "student_module_progress_moduleId_idx" ON public.student_module_progress USING btree ("moduleId");


--
-- Name: student_module_progress_studentId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "student_module_progress_studentId_idx" ON public.student_module_progress USING btree ("studentId");


--
-- Name: student_module_progress_studentId_moduleId_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX "student_module_progress_studentId_moduleId_key" ON public.student_module_progress USING btree ("studentId", "moduleId");


--
-- Name: support_ticket_replies_authorId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "support_ticket_replies_authorId_idx" ON public.support_ticket_replies USING btree ("authorId");


--
-- Name: support_ticket_replies_ticketId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "support_ticket_replies_ticketId_idx" ON public.support_ticket_replies USING btree ("ticketId");
...
--
-- Name: support_tickets_authorId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "support_tickets_authorId_idx" ON public.support_tickets USING btree ("authorId");


--
-- Name: support_tickets_deletedAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "support_tickets_deletedAt_idx" ON public.support_tickets USING btree ("deletedAt");
...
--
-- Name: teams_companyId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "teams_companyId_idx" ON public.teams USING btree ("companyId");


--
-- Name: teams_deletedAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "teams_deletedAt_idx" ON public.teams USING btree ("deletedAt");


--
-- Name: training_plan_modules_deletedAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "training_plan_modules_deletedAt_idx" ON public.training_plan_modules USING btree ("deletedAt");


--
-- Name: training_plan_modules_trainingPlanId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "training_plan_modules_trainingPlanId_idx" ON public.training_plan_modules USING btree ("trainingPlanId");


--
-- Name: training_plans_deletedAt_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "training_plans_deletedAt_idx" ON public.training_plans USING btree ("deletedAt");


--
-- Name: training_plans_teamId_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: users_deletedAt_idx; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: users_mentorId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "users_mentorId_idx" ON public.users USING btree ("mentorId");
...
--
-- Name: users_teamId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "users_teamId_idx" ON public.users USING btree ("teamId");
...
--
-- Name: invitations invitations_invitedById_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT "invitations_invitedById_fkey" FOREIGN KEY ("invitedById") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: invitations invitations_teamId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.invitations
    ADD CONSTRAINT "invitations_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES public.teams(id) ON UPDATE CASCADE ON DELETE SET NULL;


--
-- Name: leave_requests leave_requests_approvedById_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: leave_requests leave_requests_studentId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.leave_requests
    ADD CONSTRAINT "leave_requests_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: qa_answers qa_answers_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.qa_answers
    ADD CONSTRAINT qa_answers_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id);


--
-- Name: qa_questions qa_questions_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.qa_questions
    ADD CONSTRAINT qa_questions_student_id_fkey FOREIGN KEY (student_id) REFERENCES auth.users(id);
...
--
-- Name: student_module_progress student_module_progress_moduleId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_module_progress
    ADD CONSTRAINT "student_module_progress_moduleId_fkey" FOREIGN KEY ("moduleId") REFERENCES public.training_plan_modules(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: student_module_progress student_module_progress_studentId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.student_module_progress
    ADD CONSTRAINT "student_module_progress_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: support_ticket_replies support_ticket_replies_authorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.support_ticket_replies
    ADD CONSTRAINT "support_ticket_replies_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: support_ticket_replies support_ticket_replies_ticketId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.support_ticket_replies
    ADD CONSTRAINT "support_ticket_replies_ticketId_fkey" FOREIGN KEY ("ticketId") REFERENCES public.support_tickets(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: support_tickets support_tickets_authorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.support_tickets
    ADD CONSTRAINT "support_tickets_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: teams teams_companyId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.teams
    ADD CONSTRAINT "teams_companyId_fkey" FOREIGN KEY ("companyId") REFERENCES public.companies(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: training_plan_modules training_plan_modules_trainingPlanId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.training_plan_modules
    ADD CONSTRAINT "training_plan_modules_trainingPlanId_fkey" FOREIGN KEY ("trainingPlanId") REFERENCES public.training_plans(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: training_plans training_plans_createdById_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.training_plans
    ADD CONSTRAINT "training_plans_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES public.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: training_plans training_plans_teamId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.training_plans
    ADD CONSTRAINT "training_plans_teamId_fkey" FOREIGN KEY ("teamId") REFERENCES public.teams(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: users users_mentorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE qa_answers; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE qa_questions; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE support_ticket_replies; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE training_plan_modules; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.training_plan_modules TO anon;
GRANT ALL ON TABLE public.training_plan_modules TO authenticated;
GRANT ALL ON TABLE public.training_plan_modules TO service_role;
...
\unrestrict 6Pnb9ofigJlghjwhOEP7eoAyNhL8TT78y32KxCUZvRY4i9Lwb8LfuJ9aX3HHvL9
